...
export const UI_STRINGS = {
  ms: {
    ...
    chatListEmpty: "Belum ada perbualan",
    groupToday: "Hari ini",
    groupPast7Days: "7 hari lepas",
    groupOlder: "Lebih awal",
    renameChat: "Namakan semula",
    deleteChat: "Padam",
    deleteChatConfirm: "Padam perbualan ini? Tindakan ini tidak boleh dibuat asal.",
    untitledChat: "Perbualan baharu",
    tabReport: "Laporan",
    tabChat: "Pertanyaan",
